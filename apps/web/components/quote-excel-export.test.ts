...
assert.ok(uploadWorkbenchSource.includes("const DEFAULT_QUOTE_RULES_STORAGE_VERSION = 6"), "default quote rule storage version should reset stale local edited defaults after price table updates");
