...
assert.ok(html.includes('<table width="1106.70"'), "Excel draft should use the print template table width");
assert.ok(html.includes('<col width="64.90"'), "Excel draft should include the print template index column width");
assert.ok(html.includes('<col width="260.80"'), "Excel draft should give item names the print template width");
assert.ok(html.includes('<col width="293"'), "Excel draft should give process notes the print template width");
