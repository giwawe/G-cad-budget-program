...
assert.equal(MANUAL_QUOTE_DRAFT_ITEMS.length, 16);
assert.ok(html.indexOf("<td>一</td><td>全屋拆改工程</td>") < html.indexOf("<td>砌240厚砖墙</td>"));
assert.ok(html.includes("<td>卫生间门</td><td></td><td></td><td></td><td></td><td></td><td>0.00</td><td></td>"));
assert.ok(html.includes("<td>厨房推拉门双包套</td><td></td><td></td><td></td><td></td><td></td><td>0.00</td><td></td>"));
assert.ok(html.includes("<td>材料搬运费</td><td></td><td></td><td></td><td></td><td></td><td>0.00</td><td></td>"));
assert.ok(html.includes("<td>垃圾清运费</td><td></td><td></td><td></td><td></td><td></td><td>0.00</td><td></td>"));
assert.ok(html.includes("<td>地面砖现场维护费</td><td></td><td></td><td></td><td></td><td></td><td>0.00</td><td></td>"));
assert.ok(html.includes("<td>全屋插座开关</td><td></td><td></td><td></td><td></td><td></td><td>0.00</td><td></td>"));
assert.ok(html.includes("<td>美缝</td><td></td><td></td><td></td><td></td><td></td><td>0.00</td><td></td>"));
assert.ok(html.includes("<td>瓷砖加工费</td><td></td><td></td><td></td><td></td><td></td><td>0.00</td><td></td>"));
assert.ok(html.includes("<td>墙面瓷砖</td><td></td><td></td><td></td><td></td><td></td><td>0.00</td><td></td>"));
assert.ok(html.includes("<td>弱电布线</td><td></td><td></td><td></td><td></td><td></td><td>0.00</td><td></td>"));
