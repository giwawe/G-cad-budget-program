...
assert.equal(mapping.items[7].quantity, 4.48);
assert.equal(mapping.items[7].amount, 349.44);
assert.equal(mapping.items[8].quantity, 4.48);
assert.equal(mapping.items[8].amount, 132.16);
