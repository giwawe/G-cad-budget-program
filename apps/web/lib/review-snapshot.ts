...
function normalizeSnapshotRow(row: QuantityRow): QuantityRow {
  return {
    ...
    atriumCurtainWidthM: typeof row.atriumCurtainWidthM === "number" ? row.atriumCurtainWidthM : 0,
    atriumCurtainHeightM: typeof row.atriumCurtainHeightM === "number" ? row.atriumCurtainHeightM : 0,
    atriumCurtainAreaM2: typeof row.atriumCurtainAreaM2 === "number" ? row.atriumCurtainAreaM2 : 0,
    ...
    newWallUnclassifiedAreaM2: typeof row.newWallUnclassifiedAreaM2 === "number" ? row.newWallUnclassifiedAreaM2 : typeof row.newWallAreaM2 === "number" ? row.newWallAreaM2 : 0,
    newWall120AreaM2: typeof row.newWall120AreaM2 === "number" ? row.newWall120AreaM2 : 0,
    newWall240AreaM2: typeof row.newWall240AreaM2 === "number" ? row.newWall240AreaM2 : 0,
    ...
    stairRailingLengthM: typeof row.stairRailingLengthM === "number" ? row.stairRailingLengthM : 0,
    guardrailLengthM: typeof row.guardrailLengthM === "number" ? row.guardrailLengthM : 0,
