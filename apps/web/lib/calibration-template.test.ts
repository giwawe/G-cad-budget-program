...
const rows: QuantityRow[] = [
  {
    ...
    gypsumLineCeilingAreaM2: 0.8,
    gypsumLineCeilingLengthM: 3,
    noCeilingAreaM2: 0.4,
    voidAreaM2: 0.52,
    ...
    atriumCurtainWidthM: 0,
    atriumCurtainHeightM: 0,
    atriumCurtainAreaM2: 0,
    windowAreaM2: 0,
    doorWidthTotalM: 1,
    doorDeductAreaM2: 0,
...
assert.deepEqual(quantityRowsToCalibrationTemplate(rows), [
  {
    ...
    floor_area_m2: 4.48,
    ceiling_area_m2: 4.48,
    gypsum_flat_ceiling_area_m2: 3.28,
    edge_ceiling_area_m2: 1.2,
    edge_ceiling_length_m: 5,
    gypsum_line_ceiling_area_m2: 0.8,
    gypsum_line_ceiling_length_m: 3,
    no_ceiling_area_m2: 0.4,
    void_area_m2: 0.52,
    ...
    atrium_curtain_width_m: 0,
    atrium_curtain_height_m: 0,
    atrium_curtain_area_m2: 0,
    window_area_m2: 0,
