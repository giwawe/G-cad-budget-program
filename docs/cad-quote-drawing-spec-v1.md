...
推拉门面积和门套长度在工程量表中展示，并导出到校准模板：`sliding_door_area_m2` 按门宽乘推拉门高，`sliding_door_casing_length_m` 按门宽加两侧推拉门高；没有高度标识时推拉门默认高为 `2.2m`。卫生间门导出为 `bathroom_door_count`，不混入室内门数量。默认报价规则会按空间类型分别生成“卫生间门”“厨房推拉门”“厨房推拉门双包套”“阳台推拉门”“阳台推拉门双包套”，其中阳台和露台空间的推拉门归入阳台推拉门口径，不需要专门新增图层。
