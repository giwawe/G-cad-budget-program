...
厨房推拉门面积 = 厨房空间内推拉门宽度 * 推拉门高；未标注高度时默认推拉门高为 2.2m
厨房推拉门门套长度 = 厨房空间内推拉门宽度 + 2 * 推拉门高；未标注高度时默认推拉门高为 2.2m
...
厨房推拉门面积和门套长度在工程量表中展示，并导出到校准模板：`sliding_door_area_m2` 按门宽乘推拉门高，`sliding_door_casing_length_m` 按门宽加两侧推拉门高；没有高度标识时厨房推拉门默认高为 `2.2m`。卫生间门导出为 `bathroom_door_count`，不混入室内门数量。默认报价规则会分别生成“卫生间门”“厨房推拉门”“厨房推拉门双包套”，单价按真实模板分别为 1200、550、300。
