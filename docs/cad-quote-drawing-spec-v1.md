...
报价映射区域会提示 Excel 草稿包含 18 项“人工补项”；这些项目只用于提醒报价员补填，不写入报价映射 `items`，也不影响 `summary.total_amount`。已自动接入的拆改及拆墙、卫生间门、厨房推拉门、厨房推拉门双包套、材料搬运费、垃圾清运费、地面砖现场维护费、弱电布线、全屋插座开关、全屋保洁、地面瓷砖、墙面瓷砖、美缝和瓷砖加工费不再重复放入人工补项。
