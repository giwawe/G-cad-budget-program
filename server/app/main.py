...
def _serialize_drawing(drawing: DrawingGeometry) -> dict:
    return {
        ...
        "opening_edges": [_segment_to_dict(segment) for segment in drawing.opening_edges],
        "void_boundaries": [[_point_to_dict(point) for point in boundary] for boundary in drawing.void_boundaries],
        "railings": [_segment_to_dict(segment) for segment in drawing.railings],
        ...
        "background_walls": [_segment_to_dict(segment) for segment in drawing.background_walls],
        "cast_slab_boundaries": [[_point_to_dict(point) for point in boundary] for boundary in drawing.cast_slab_boundaries],
        "edge_ceiling_boundaries": [[_point_to_dict(point) for point in boundary] for boundary in drawing.edge_ceiling_boundaries],
        "gypsum_line_ceiling_boundaries": [[_point_to_dict(point) for point in boundary] for boundary in drawing.gypsum_line_ceiling_boundaries],
        "no_ceiling_boundaries": [[_point_to_dict(point) for point in boundary] for boundary in drawing.no_ceiling_boundaries],
...
def _stable_quantity_row(row: dict) -> dict:
    return {
        ...
        "ceiling_area_m2": row["ceiling_area_m2"],
        "void_area_m2": row["void_area_m2"],
        ...
        "atrium_curtain_width_m": row["atrium_curtain_width_m"],
        "atrium_curtain_height_m": row["atrium_curtain_height_m"],
        "atrium_curtain_area_m2": row["atrium_curtain_area_m2"],
        ...
        "new_wall_unclassified_area_m2": row["new_wall_unclassified_area_m2"],
        "new_wall_120_area_m2": row["new_wall_120_area_m2"],
        "new_wall_240_area_m2": row["new_wall_240_area_m2"],
        ...
        "cast_slab_area_m2": row["cast_slab_area_m2"],
        "edge_ceiling_area_m2": row["edge_ceiling_area_m2"],
        "edge_ceiling_length_m": row["edge_ceiling_length_m"],
        "gypsum_line_ceiling_area_m2": row["gypsum_line_ceiling_area_m2"],
        "gypsum_line_ceiling_length_m": row["gypsum_line_ceiling_length_m"],
        "no_ceiling_area_m2": row["no_ceiling_area_m2"],
        "gypsum_flat_ceiling_area_m2": row["gypsum_flat_ceiling_area_m2"],
        ...
        "stair_railing_length_m": row["stair_railing_length_m"],
        "guardrail_length_m": row["guardrail_length_m"],
        "status": row["status"],
