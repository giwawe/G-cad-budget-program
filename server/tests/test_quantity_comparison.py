...
def test_compare_quantity_rows_reports_floor_tile_piece_count_differences_by_default():
    actual_rows = [{"space_name": "客厅", "floor_tile_piece_count": 28}]
    expected_rows = [{"space_name": "客厅", "floor_tile_piece_count": 27}]
...
def test_compare_quantity_rows_reports_kitchen_cabinet_length_differences_by_default():
    actual_rows = [{"space_name": "厨房", "kitchen_base_cabinet_length_m": 4.3, "kitchen_wall_cabinet_length_m": 3.0}]
    expected_rows = [{"space_name": "厨房", "kitchen_base_cabinet_length_m": 3.8, "kitchen_wall_cabinet_length_m": 2.4}]
...
def test_compare_quantity_rows_reports_custom_cabinet_area_differences_by_default():
    actual_rows = [{"space_name": "主卧", "custom_cabinet_area_m2": 7.2}]
